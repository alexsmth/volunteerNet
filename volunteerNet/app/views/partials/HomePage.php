        ...
        <div id="HomePage" align = "center">
            ...
            <div id = "buttondivide" align = "right">
                <table style="position: absolute; top: 0; right: 0;">
                    <th>
                        <button class="homepagebuttons" align="center" action = "<?php print_link("MissionsController.php")?>" target="_self">Volunteer</button>
                    </th>

                    <th>
                        <button class="homepagebuttons" align="center" action = "<?php print_link("homeController.php")?>" target="_self">Home</button>
                    </th>

                    <th>
                        <button class="homepagebuttons" align="center" action = "<?php print_link("LoginController.php")?>" target="_self">Login</button>
                    </th>

                    <th>
                        <button class="homepagebuttons" align="center" action = "<?php print_link("AskForHelpController.php")?>" target="_self">Ask for help</button>
                     </th>
                </table>
            </div>
